-- Obtener todas las actualizaciones de condiciones actividad con filtros opcionales
SELECT 
    a.id,
    a.id_actividad,
    a.nombre_actividad_anterior,
    a.nombre_actividad_nuevo,
...
FROM auditoria_actualizacion_condiciones_actividad a
...
WHERE 
    ...
    AND (
        ...
        OR a.nombre_actividad_anterior ILIKE '%' || $4 || '%'
        OR a.nombre_actividad_nuevo ILIKE '%' || $4 || '%'
    )
ORDER BY 
