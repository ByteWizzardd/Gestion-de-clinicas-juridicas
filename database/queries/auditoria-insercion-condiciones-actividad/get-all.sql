-- Obtener todos los condiciones-actividad insertados con filtros opcionales
-- Parámetros opcionales:
-- $1 = fecha_inicio (DATE, opcional)
-- $2 = fecha_fin (DATE, opcional)
-- $3 = id_usuario_creo (VARCHAR, opcional)
-- $4 = busqueda (TEXT, opcional) - busca en id_actividad, nombre_actividad
...
FROM auditoria_insercion_condiciones_actividad a
