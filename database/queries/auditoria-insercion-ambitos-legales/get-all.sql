-- Obtener todos los ambitos-legales insertados con filtros opcionales
-- Parámetros opcionales:
-- $1 = fecha_inicio (DATE, opcional)
-- $2 = fecha_fin (DATE, opcional)
-- $3 = id_usuario_creo (VARCHAR, opcional)
-- $4 = busqueda (TEXT, opcional) - busca en num_ambito_legal, nombre_ambito_legal
...
FROM auditoria_insercion_ambitos_legales a
...
WHERE 
    ...
    AND (
        ...
        OR a.nombre_ambito_legal ILIKE '%' || $4 || '%'
    )
ORDER BY 
