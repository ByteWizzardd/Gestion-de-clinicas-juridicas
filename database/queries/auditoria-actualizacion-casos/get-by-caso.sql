-- Obtener todas las actualizaciones de un caso específico incluyendo cambios de estatus
...
WITH actualizaciones_combinadas AS (
    ...
    WHERE ce.id_caso = $1
      -- Solo incluir cambios que no son el primero
      AND ce.num_cambio > 1
)
SELECT 
    ac.id,
    ...
    ac.fecha_solicitud_anterior, ac.fecha_solicitud_nuevo,
    ac.fecha_inicio_caso_anterior, ac.fecha_inicio_caso_nuevo,
    ac.fecha_fin_caso_anterior, ac.fecha_fin_caso_nuevo,
