-- Obtener todos los subcategorias insertados con filtros opcionales
-- Parámetros opcionales:
-- $1 = fecha_inicio (DATE, opcional)
-- $2 = fecha_fin (DATE, opcional)
-- $3 = id_usuario_creo (VARCHAR, opcional)
-- $4 = busqueda (TEXT, opcional) - busca en num_subcategoria, nombre_subcategoria
...
FROM auditoria_insercion_subcategorias a
...
WHERE 
    ...
    AND (
        ...
        OR a.nombre_subcategoria ILIKE '%' || $4 || '%'
    )
ORDER BY 
