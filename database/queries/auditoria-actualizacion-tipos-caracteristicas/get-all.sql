-- Obtener todas las actualizaciones de tipos caracteristicas con filtros opcionales
SELECT 
    a.id,
    a.id_tipo,
    a.nombre_tipo_caracteristica_anterior,
    a.nombre_tipo_caracteristica_nuevo,
...
FROM auditoria_actualizacion_tipos_caracteristicas a
...
WHERE 
    ...
    AND (
        ...
        OR a.nombre_tipo_caracteristica_anterior ILIKE '%' || $4 || '%'
        OR a.nombre_tipo_caracteristica_nuevo ILIKE '%' || $4 || '%'
    )
ORDER BY 
