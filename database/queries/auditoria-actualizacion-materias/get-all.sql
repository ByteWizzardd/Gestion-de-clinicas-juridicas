-- Obtener todas las actualizaciones de materias con filtros opcionales
SELECT 
    a.id,
    a.id_materia,
    a.nombre_materia_anterior,
    a.nombre_materia_nuevo,
...
FROM auditoria_actualizacion_materias a
...
WHERE 
    ...
    AND (
        ...
        OR a.nombre_materia_anterior ILIKE '%' || $4 || '%'
        OR a.nombre_materia_nuevo ILIKE '%' || $4 || '%'
    )
ORDER BY 
