...
LEFT JOIN public.usuarios u ON a.cedula_estudiante = u.cedula
LEFT JOIN public.auditoria_insercion_usuarios au_hist ON a.cedula_estudiante = au_hist.cedula 
