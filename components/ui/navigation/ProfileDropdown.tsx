          ...
          >
            ...
            <div className="py-1">
              <button
                ...
                className="group w-full px-4 py-2.5 text-left text-base text-(--dropdown-text) hover:text-(--dropdown-text-hover) hover:bg-(--dropdown-hover) flex items-center gap-3 transition-colors cursor-pointer"
              >
                <User className="w-4 h-4 text-(--dropdown-text) group-hover:text-(--dropdown-text-hover) transition-colors" />
                Perfil
              </button>
              ...
              <button
                ...
                className="group w-full px-4 py-2.5 text-left text-base text-(--dropdown-text) hover:text-(--dropdown-text-hover) hover:bg-(--dropdown-hover) flex items-center gap-3 transition-colors cursor-pointer"
              >
                <Key className="w-4 h-4 text-(--dropdown-text) group-hover:text-(--dropdown-text-hover) transition-colors" />
                Cambiar contraseña
              </button>
              ...
              <button
                ...
                className="group w-full px-4 py-2.5 text-left text-base text-(--dropdown-text) hover:text-(--dropdown-text-hover) hover:bg-(--dropdown-hover) flex items-center gap-3 transition-colors cursor-pointer"
              >
                <HelpCircle className="w-4 h-4 text-(--dropdown-text) group-hover:text-(--dropdown-text-hover) transition-colors" />
              ...
              <button
                ...
                className="group w-full px-4 py-2.5 text-left text-base text-(--dropdown-text) hover:text-(--dropdown-text-hover) hover:bg-(--dropdown-hover) flex items-center justify-between transition-colors cursor-pointer"
              >
                <div className="flex items-center gap-3">
                  {mounted && isDarkMode ? (
                    <Sun className="w-4 h-4 text-(--dropdown-text) group-hover:text-(--dropdown-text-hover) transition-colors" />
                  ) : (
                    <Moon className="w-4 h-4 text-(--dropdown-text) group-hover:text-(--dropdown-text-hover) transition-colors" />
                  )}
            ...
            <div className="py-1">
              <button
                ...
                className="group w-full px-4 py-2.5 text-left text-base text-(--dropdown-text) hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 flex items-center gap-3 transition-colors cursor-pointer"
              >
                <LogOut className="w-4 h-4 text-(--dropdown-text) group-hover:text-red-600 transition-colors" />
                Cerrar sesión
              </button>
            </div>
          </motion.div>
