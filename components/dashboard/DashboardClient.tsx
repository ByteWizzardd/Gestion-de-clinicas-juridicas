    ...
    <div className="max-h-screen">
      <div className="max-w-[1920px] mx-auto px-4 md:px-6 lg:px-8">
        <div className="mb-4 md:mb-6 mt-4">
          ...
          <p className="text-sm md:text-base text-(--card-text-muted) transition-colors" style={{ fontFamily: 'var(--font-urbanist)' }}>
        ...
        <div className="flex flex-col lg:flex-row gap-4 md:gap-6 mt-4 md:mt-6 h-[calc(100vh-8rem)] md:h-[calc(100vh-10rem)]">
          <div className="flex flex-col gap-4 md:gap-6 flex-1 max-w-full">
            <motion.div
              className="bg-(--card-bg) border border-(--card-border) rounded-2xl md:rounded-3xl shadow-[0px_4px_10px_0px_rgba(0,0,0,0.30)] p-4 md:p-6 flex-1 flex flex-col min-h-0 transition-colors"
              initial={{ opacity: 0.5 }}
              animate={{ opacity: 1 }}
              transition={{ duration: 0.1, ease: "easeOut" }}
            >
              <div className="flex items-center justify-between mb-4 shrink-0 px-2">
                <h3 className="text-xl md:text-2xl font-semibold text-(--card-text) transition-colors">
                  {isCoordinator ? 'Casos' : 'Mis Casos'}
                </h3>
                <span className="text-sm text-(--card-text-muted) transition-colors">
          ...
          <div className="flex-1 w-full lg:min-w-94 lg:max-w-116 2xl:max-w-md">
            <motion.div
              className="bg-(--card-bg) border border-(--card-border) rounded-2xl md:rounded-3xl shadow-[0px_4px_10px_0px_rgba(0,0,0,0.30)] p-4 md:p-6 h-full min-h-[200px] lg:min-h-0 flex flex-col transition-colors"
              initial={{ opacity: 0.5 }}
              animate={{ opacity: 1 }}
              transition={{ duration: 0.1, ease: "easeOut" }}
            >
              <h3 className="text-xl md:text-2xl font-semibold text-center text-(--card-text) mb-4 md:mb-6 shrink-0 transition-colors">
