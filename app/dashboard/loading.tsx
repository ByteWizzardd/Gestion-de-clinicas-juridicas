      ...
      <div className="max-w-[1920px] mx-auto px-4 md:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row gap-4 md:gap-6 mt-4 md:mt-6 h-[calc(100vh-8rem)] md:h-[calc(100vh-10rem)]">
          ...
          <div className="flex flex-col gap-4 md:gap-6 flex-1 max-w-full">
            ...
            {/* Sección: Mis Casos */}
            <div className="bg-white rounded-2xl md:rounded-3xl shadow-[0px_4px_10px_0px_rgba(0,0,0,0.1)] p-4 md:p-6 flex-1 flex flex-col min-h-0 relative overflow-hidden">
              {/* Header Casos */}
            ...
            {/* Sección: Mi Agenda */}
            <div className="bg-white rounded-2xl md:rounded-3xl shadow-[0px_4px_10px_0px_rgba(0,0,0,0.1)] p-4 md:p-6 w-full flex-1 flex flex-col min-h-0 relative overflow-hidden">
              <div className="flex flex-col md:flex-row gap-4 md:gap-6 flex-1 min-h-0">
                ...
                <div className="w-full md:w-1/2 flex flex-col min-h-0">
                  ...
                  <div className="space-y-4 pr-2">
                    {[...Array(3)].map((_, i) => (
                      <div key={i} className="flex gap-3 p-3 bg-gray-50/50 rounded-xl">
          ...
          <div className="flex-1 w-full lg:min-w-94 lg:max-w-116 2xl:max-w-md">
            <div className="bg-white rounded-2xl md:rounded-3xl shadow-[0px_4px_10px_0px_rgba(0,0,0,0.1)] p-4 md:p-6 h-full min-h-[200px] lg:min-h-0 flex flex-col relative overflow-hidden">
