                    ...
                    <>
                        ...
                        <motion.div
                            ...
                            <Image
                                ...
                                width={240}
                                height={87}
                                className="object-contain w-36 sm:w-60 h-auto"
                            />
                        </motion.div>
            ...
            <div className="flex min-h-svh justify-center items-center relative z-10 px-4">
                <AnimatePresence>
                    {!isExiting && (
                        <motion.div
                            key="card"
                            className="w-full max-w-md bg-[var(--card-bg)] rounded-3xl sm:rounded-4xl shadow-[0px_4px_20px_0px_rgba(0,0,0,0.25)] dark:shadow-[0px_4px_25px_0px_rgba(0,0,0,0.5)] overflow-hidden flex flex-col items-center justify-center p-6 sm:p-8 py-10 sm:py-12 border border-[var(--card-border)] transition-colors duration-300"
                            initial={prefersReducedMotion ? { opacity: 1 } : { opacity: 0 }}
                            animate={{ opacity: 1 }}
                            exit={prefersReducedMotion ? { opacity: 1 } : { opacity: 0 }}
                            transition={prefersReducedMotion ? { duration: 0 } : { duration: 0.2, ease: "easeOut" }}>
